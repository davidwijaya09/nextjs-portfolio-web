				...
				<div className="container">
					<div className="text-wrapper w-full">
						...
						<p className="description">
							Welcome to David's Portfolio. Dive into a curated collection of my most noteworthy projects, professional experiences, and skills. From web development to graphic design, explore the breadth and depth of my expertise.
						</p>
